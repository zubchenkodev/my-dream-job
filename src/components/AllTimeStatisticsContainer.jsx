...
const AllTimeStatisticsContainer = () => {
    ...
    return (
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-8">
        {statusStats.map((statusStat, index) => {
          return (
            <StatCard key={index} statusStat={statusStat} jobsThisMonth={jobsThisMonth} jobs={jobs} isLoading={isLoading} allTime/>
          )
        } )}
      </div>
    )
...
export default AllTimeStatisticsContainer